...
struct LoadClassificationTableParams;
...
class LoadClassificationTable : public SimObject
{
  ...
  private:
    ...
    /** Threshold for marking load as constant (consecutive correct predictions) */
    static constexpr unsigned CONSTANT_THRESHOLD = 30;
