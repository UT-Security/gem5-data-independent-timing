...
from components.processors.custom_arm_switchable_processor import (
    CustomARMSwitchableProcessor,
)
...
processor = CustomARMSwitchableProcessor(SwitchCPUCls=O3_ARM_v8_3)
# processor = CustomARMProcessor(CPUCls=O3_ARM_v8_3)
