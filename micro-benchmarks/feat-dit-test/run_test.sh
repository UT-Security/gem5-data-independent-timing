...
# Script to run FEAT_DIT test with gem5

GEM5_ROOT="/home/rgangar/Documents/gem5"
CONFIG_SCRIPT="$GEM5_ROOT/custom-configs/se_custom_arm_binary.py"
TEST_BINARY="$GEM5_ROOT/micro-benchmarks/feat-dit-test/test_dit"
GEM5_BIN="$GEM5_ROOT/build/ARM/gem5.opt"
OUTPUT_DIR="$GEM5_ROOT/micro-benchmarks/feat-dit-test/output"
...
if [ ! -f "$TEST_BINARY" ]; then
    ...
    echo "Run 'make' in the feat-dit-test directory first"
    exit 1
fi
