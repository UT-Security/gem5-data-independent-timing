...
from components.processors.custom_arm_core import CustomARMCore
import components.processors.simargs_switchable_processor as simargs

class CustomARMSwitchableProcessor(SwitchableProcessor):
    """
    ...
    def __init__(
        ...
        print(f"Creating ARM Switchable Processor: num_cores={num_cores}, start_core_type={starting_core_type}, switch_core_type={switch_core_type}")
